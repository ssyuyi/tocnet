...
class wm_DetLocalVisualizer(Visualizer):
    ...
    def add_datasample(
        ...
        yilou, wujian = self.yilou_and_wujian(gt, pd)
        ...
        self._draw_img(image, gt, green, 'rec')
        self._draw_img(image, pd, red, 'rec')
        self._draw_img(image, yilou, blue, 'ovl')
        self._draw_img(image, wujian, black, 'ovl')
